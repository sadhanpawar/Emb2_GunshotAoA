...
uint32_t micsSamplesAlternate[32 + 32];
...
void initDma(void)
{
    ...
    dmaControlBlockMem[14].dstEndPtr = &micsSamplesAlternate[0] + 32;
    ...
    dmaControlBlockMem[0x200+14].dstEndPtr = &micsSamplesAlternate[18] + 32;
